    ...
    <div class="auto-illustrator-settings">
      <div class="inline-drawer">
        ...
        <div class="inline-drawer-content">
          ...
          <!-- Enable toggle + Reset (always visible at top) -->
          ...
          <!-- Section 1: Basic Settings (default expanded) -->
          <div class="inline-drawer">
            <div class="inline-drawer-toggle inline-drawer-header">
              <b><i class="fa-solid fa-sliders"></i> ${t('settings.sectionBasic')}</b>
              <div class="inline-drawer-icon fa-solid fa-circle-chevron-down down"></div>
            </div>
          ...
          <!-- Section 2: Generation Control -->
          <div class="inline-drawer">
            <div class="inline-drawer-toggle inline-drawer-header">
              <b><i class="fa-solid fa-gear"></i> ${t('settings.sectionGeneration')}</b>
              <div class="inline-drawer-icon fa-solid fa-circle-chevron-down down"></div>
            </div>
            <div class="inline-drawer-content">
          ...
          <div class="inline-drawer">
            <div class="inline-drawer-toggle inline-drawer-header">
              <b><i class="fa-solid fa-wand-magic-sparkles"></i> ${t('settings.sectionPrompt')}</b>
              <div class="inline-drawer-icon fa-solid fa-circle-chevron-down down"></div>
            </div>
            <div class="inline-drawer-content">
          ...
          <!-- Section 4: Interface & Debug -->
          <div class="inline-drawer">
            <div class="inline-drawer-toggle inline-drawer-header">
              <b><i class="fa-solid fa-display"></i> ${t('settings.sectionInterface')}</b>
              <div class="inline-drawer-icon fa-solid fa-circle-chevron-down down"></div>
            </div>
            <div class="inline-drawer-content">
